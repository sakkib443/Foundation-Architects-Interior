    ...
    <div class="mx-auto grid max-w-7xl items-center gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div class="relative">
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-4 pt-8">
                    <div class="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black/5">
                        <img src="{{ asset('images/portfolio/project-1.jpg') }}" alt="Interior project" loading="lazy"
                             class="aspect-[3/4] w-full object-cover transition duration-700 hover:scale-105">
                    </div>
                    <div class="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black/5">
                        <img src="{{ asset('images/portfolio/project-3.jpg') }}" alt="Interior project" loading="lazy"
                             class="aspect-square w-full object-cover transition duration-700 hover:scale-105">
                    </div>
                </div>
                <div class="space-y-4">
                    <div class="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black/5">
                        <img src="{{ asset('images/portfolio/project-4.jpg') }}" alt="Interior project" loading="lazy"
                             class="aspect-square w-full object-cover transition duration-700 hover:scale-105">
                    </div>
                    <div class="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black/5">
                        <img src="{{ asset('images/portfolio/project-2.jpg') }}" alt="Interior project" loading="lazy"
                             class="aspect-[3/4] w-full object-cover transition duration-700 hover:scale-105">
                    </div>
                </div>
            </div>
            ...
            <div class="absolute -bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-3 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 px-6 py-4 text-white shadow-xl">
                <span class="font-display text-3xl font-bold leading-none">10+</span>
                <span class="text-xs font-medium leading-tight text-white/90">Years of<br>Design Excellence</span>
            </div>
        </div>
        ...
        <div>
            ...
            <h2 class="mt-5 font-display text-4xl font-bold leading-tight tracking-tight text-brand-900 sm:text-[2.75rem]">
                Building Spaces, Crafting Lifestyles
            </h2>

            <p class="mt-5 leading-relaxed text-stone-600">
                Foundation Architects &amp; Interior began in 2016 with a simple belief — that good design should be
                honest, functional, and made for the people who live in it. What started as a small team of dreamers
                has grown into a full-service architecture and interior studio trusted across Bangladesh.
            </p>
            <p class="mt-4 leading-relaxed text-stone-600">
                From the first sketch to the final handover, we manage every detail in-house — architecture, interior
                styling, 3D visualization, and on-site execution. The result is a calm, seamless experience and spaces
