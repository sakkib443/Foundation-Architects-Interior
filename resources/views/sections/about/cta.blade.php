    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 px-6 py-14 text-center shadow-2xl shadow-brand-900/30 sm:px-12 sm:py-20">
            ...
            <div class="relative mx-auto max-w-2xl">
                <p class="font-script text-3xl leading-none text-brand-200 sm:text-4xl">Let's Work Together</p>
                ...
                <p class="mx-auto mt-4 max-w-xl text-white/85">
                    Tell us about your space and your vision — our team will turn it into a place you'll love to
                    live and work in. Your free consultation is just one call away.
                </p>
