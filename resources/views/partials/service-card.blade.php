...
<div class="group flex flex-col rounded-2xl border border-stone-100 bg-white p-7 shadow-sm ring-1 ring-stone-900/5 transition duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-stone-900/10">

    <a href="{{ route('services.show', $slug) }}" class="flex flex-1 flex-col">
        {{-- Icon --}}
