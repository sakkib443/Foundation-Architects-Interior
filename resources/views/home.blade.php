    ...
    <section id="home" class="relative h-screen min-h-[600px] w-full overflow-hidden">
        ...
        <div class="absolute inset-0">
            @foreach ($slides as $i => $slide)
                <div data-hero-slide
                     class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out {{ $i === 0 ? 'opacity-100' : 'opacity-0' }}"
        ...
        <div class="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center sm:px-6">
            ...
            {{-- Cursive tagline --}}
            <p class="hero-text-shadow font-script text-4xl leading-none text-white sm:text-5xl lg:text-6xl">
                Foundation Architects &amp; Interior, Design for Life.
            </p>

            {{-- Headline + sub + buttons --}}
            <div class="mt-6 flex max-w-3xl flex-col items-center">
                <h1 class="hero-text-shadow font-display text-3xl font-semibold leading-tight text-white sm:text-5xl">
                    Crafting Beautiful Interiors Across Bangladesh
                </h1>
                <p class="hero-text-shadow mt-4 max-w-xl text-base text-white/90 sm:text-lg">
                    A trusted name in the interior sector — turning your space into a place you'll love to live and work in.
                </p>
        ...
        <div class="absolute inset-x-0 bottom-8 z-10 flex items-center justify-center gap-2">
            @foreach ($slides as $i => $slide)
